...
//            Session.Clear();
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                WebsiteManager.SaveExamLog(this, null, string.Format("ورود به سیستم آموزش [{0}] [{1}]", Request.UserHostAddress, Request.UserAgent));
                Response.Redirect("~/Student/OnlineExam/pageExamList.aspx", false);
            }
        }
    ...
    {
        Response.Redirect("~/Student/OnlineExam/pageCredential.aspx", true);
    }
