...
public partial class Student_pageSectionEnroll : Page
{
    ...
    protected void btnPay_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            payTransaction.Save();
            WebsiteManager.SaveEnrollmentLog(this, WebsiteHandler.CurrentStudent, string.Format("Payment #{0} Started with ReferenceId={1}", payTransaction.Id, payTransaction.ReferenceId));
            ...
            Response.Redirect("~/Student/Enrollment/pageSectionEnrollment3.aspx", false);
            return;
        }
