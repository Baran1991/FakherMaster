...
{
    public partial class frmStoreSupplyInvoiceDetail : rRadForm
    {
        public frmStoreSupplyInvoiceDetail()
        {
            InitializeComponent();
        ...
        private void radBtnSearch_Click(object sender, EventArgs e)
        {
            ...
            IQueryable<EducationalToolSupply> suplies = EducationalToolSupply.GetSuplies(rTextBox1.Text.Trim());
