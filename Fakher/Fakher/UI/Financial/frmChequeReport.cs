...
{
    public partial class frmChequeReport : rRadForm
    {
        ...
        public frmChequeReport()
        {
            ...
            rGridView2.Mappings.Add(new ColumnMapping { Caption = "شماره چک", ObjectProperty = "ChequeNumber" });
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //var list = DbContext.Entity<Cheque>().Where(m => m.Item.Date<= date2 && m.Item.Date >= date1);

            List<Cheque> cheques = Cheque.GetCheques(date1, date2).ToList();
            rGridView2.DataBind(cheques);            
        }
