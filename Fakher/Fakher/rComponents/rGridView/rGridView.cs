...
{
    public partial class rGridView : UserControl, IValidatableControl
    {
...
//            }
        ...
        public void RemoveSelectedRow()
        {
            ...
            if(mRawData.Contains(row.DataBoundItem))
        ...
        internal void UpdateTopToolbar()
        {
            ...
            foreach (RadItem removingItem in removingItems)
                if(radStatusStrip1.Items.Contains(removingItem))
