...
namespace Fakher.Reports
{
    ...
    /// </summary>
    public partial class rptTransitionReceipt : Report, IConfigurableReport
    {
        public rptTransitionReceipt()
        {
            //
        ...
        {
            return register.Period.TransitionReceiptNote;
        }

        public static string GetChequeText(Register register)
        {
            if (!register.Transition.ReturnByCheque)
                return "";
            Cheque cheque = register.Transition.FinancialItem.Payment as Cheque;
