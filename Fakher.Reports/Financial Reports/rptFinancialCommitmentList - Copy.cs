...
namespace Fakher.Reports
{
    ...
    public partial class rptFinancialCommitmentList : Report, IConfigurableReport
    {
        ...
        public async  void PrepareDataset(IReportParameterForm frm)
        {
            IQueryable<FinancialCommitment> commitments =(await FinancialCommitment.GetCommitments(frm.StartDate, frm.EndDate)).AsQueryable();
            DataSet = commitments;
        }
