...
namespace Fakher.Reports
{
    ...
    /// </summary>
    public partial class rptReceiptListSendingDates : Report, IConfigurableReport
    {
        public List<Receipt> fItems { get; set; } = new List<Receipt>();
        public rptReceiptListSendingDates()
        {
            //
