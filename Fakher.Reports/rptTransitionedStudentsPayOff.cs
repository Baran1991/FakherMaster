...
namespace Fakher.Reports
{
    ...
    /// </summary>
    public partial class rptTransitionedStudentsPayOff : Report, IConfigurableReport
    {
        private IReportParameterForm mFrm;
        public rptTransitionedStudentsPayOff()
        {
            //
                ...
                return new List<List<object>>
                           {
                              ...
                              new List<object> {"درس/سطح", "SectionItem.Lesson.Name"},
                               ...
                               new List<object> {"شهریه", "Register.FinancialDocument.Balance", typeof(float)},
                               ...
                               new List<object> {"چک", "Register.FinancialDocument.ChequeBalance()", typeof(float)},
                                new List<object> {"وضعیت دانشجو", "Register.FinancialDocument.FarsiFinancialStatusText" },
                               new List<object> {"وضعیت موسسه نسبت به شعبه مقصد", "Register.Transition.Branch.Name" }
                           };
            }
        }
        ...
        public void Apply(IReportParameterForm frm)
        {
            ...
            txtReportName.Value = ReportName +" "+ "به شعبه  " + frm.Param1SelectedValue+" "+"از تاریخ"+ frm.StartDate+" "+"تا تاریخ "+frm.EndDate;
            DataSource = DataSet;
        }
    }
}