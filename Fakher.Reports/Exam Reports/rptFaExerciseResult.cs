...
namespace Fakher.Reports
{
    ...
    /// </summary>
    public partial class rptFaExerciseResult : Report, IConfigurableReport
    {
        private static Exam mExam;
        private static ExamSection mExamSection;

        public rptFaExerciseResult()
        {
            //
        ...
        public static int rptFaExamResult_GetRank(ExerciseParticipate participate)
        {
        ...
        {
            if(mExamSection != null)
                textBox6.Value = "نتایج تمرین " + mExam.Name + " " + mExamSection.SectionItem.Section.FarsiName + " [" + mExam.Date.ToShortDateString() + "] [" + mExam.QuestionCount + " سئوال]";
            else
                textBox6.Value = "نتایج تمرین " + mExam.Name + " [" + mExam.Date.ToShortDateString() + "] [" + mExam.QuestionCount + " سئوال]";
        }
        ...
        public void PrepareDataset(IReportParameterForm frm)
        {
            ...
            if (frm.ExamSection != null)
            {
                ...
                IQueryable<ExerciseParticipate> participates = frm.Exam.GetFarsiOrderedExerciseParticipates(frm.ExamSection);
