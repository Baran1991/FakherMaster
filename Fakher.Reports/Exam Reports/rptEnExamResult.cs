...
namespace Fakher.Reports
{
    ...
    public partial class rptEnExamResult : Report, IConfigurableReport
    {
        private static Exam mExam;
        private static ExamSection mExamSection;

        public rptEnExamResult()
        {
            //
        ...
        private void textBox6_ItemDataBinding(object sender, EventArgs e)
        {
            if(mExamSection != null)
                textBox6.Value = "Exam Result of " + mExam.Name + " " + mExamSection.SectionItem.Section.EnglishName + " [" + mExam.Date.ToShortDateString() + "] [" + mExam.QuestionCount + " Questions]";
            else
                textBox6.Value = "Exam Result of " + mExam.Name + " [" + mExam.Date.ToShortDateString() + "] [" + mExam.QuestionCount + " Questions]";
        }
        ...
        public static int rptEnExamResult_GetRank(ExamParticipate participate)
        {
...
//                left += txt2.Size.Width.Value;
        ...
        {
            get { return "گزارش نتایج آزمون (انگلیسی)"; }
        }
        ...
        public void PrepareDataset(IReportParameterForm frm)
        {
            ...
            if (frm.ExamSection != null)
            {
                ...
                IQueryable<ExamParticipate> participates = frm.Exam.GetEnglishOrderedParticipates(frm.ExamSection);
