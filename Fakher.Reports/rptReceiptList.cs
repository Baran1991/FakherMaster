...
namespace Fakher.Reports
{
    ...
    /// </summary>
    public partial class rptReceiptList : Report, IConfigurableReport
    {
        public rptReceiptList()
        {
            //
        ...
        public void Configure(IReportParameterForm frm)
        {
            frm.ShowDate = true;
            frm.ShowParam1 = true;
            frm.Param1Text = "وضعیت فیش:";
            frm.Param1DataSource = typeof(ReceiptStatus).GetEnumDescriptions();
        }
        ...
        public void PrepareDataset(IReportParameterForm frm)
        {
            ...
            DataSet = Receipt.GetReceipt(orderedReceipts, status);
