...
namespace Fakher.Reports
{
    ...
    /// </summary>
    public partial class rptNCImageLessStudents : Report, IConfigurableReport
    {
        public rptNCImageLessStudents()
        {
            //
        ...
        {
            get { return " گزارش دانشجویان فاقد عکــس کارت ملی"; }
        }
        ...
        public void PrepareDataset(IReportParameterForm frm)
        {
            ...
            {
                registers = Register.GetNCImageLessRegisters(frm.Period, frm.SectionItem.Lesson);
            }
            else if (frm.Lesson != null)
            {
                registers = Register.GetNCImageLessRegisters(frm.Period, frm.Lesson);
            }
            else
            {
                registers = Register.GetNCImageLessRegisters(frm.Period, frm.Major);
            }
            DataSet = registers;
        }
