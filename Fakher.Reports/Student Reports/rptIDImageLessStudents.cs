...
namespace Fakher.Reports
{
    ...
    /// </summary>
    public partial class rptIDImageLessStudents : Report, IConfigurableReport
    {
        public rptIDImageLessStudents()
        {
            //
        ...
        {
            get { return "گزارش دانشجویان فاقد عکــس شناسنامه"; }
        }
        ...
        public void PrepareDataset(IReportParameterForm frm)
        {
            ...
            {
                registers = Register.GetIDImageLessRegisters(frm.Period, frm.SectionItem.Lesson);
            }
            else if (frm.Lesson != null)
            {
                registers = Register.GetIDImageLessRegisters(frm.Period, frm.Lesson);
            }
            else
            {
                registers = Register.GetIDImageLessRegisters(frm.Period, frm.Major);
            }
            DataSet = registers;
        }
