<%@ Page Title="ارسال پیام جدید" Language="C#" MasterPageFile="~/Instructor/InstructorMasterPage.master"
    AutoEventWireup="true" CodeFile="pageCompose.aspx.cs" Inherits="Instructor_MessageBox_pageCompose" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="CenterContentPlaceHolder" runat="Server">
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" Skin="Forest">
        <Windows>
            <telerik:RadWindow ID="RadWindow1" runat="server" Modal="true" Title="انتخاب دپارتمان"
                VisibleOnPageLoad="True" VisibleTitlebar="true" VisibleStatusbar="true" Visible="False"
                Height="300px" Width="500px" Style="z-index: 8001;" Behaviors="Close">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="Panel3" runat="server" Font-Names="Tahoma" HorizontalAlign="Center">
                        <telerik:RadButton ID="rBtnDepartmentSelect" runat="server" Text="انتخـاب" Font-Names="Tahoma"
                            OnClick="rBtnDepartmentSelect_Click">
                        </telerik:RadButton>
                    </asp:Panel>
                </ContentTemplate>
            </telerik:RadWindow>
            <telerik:RadWindow ID="RadWindow2" runat="server" Modal="true" Title="انتخاب مدرس"
                VisibleOnPageLoad="True" VisibleTitlebar="true" VisibleStatusbar="true" Visible="False"
            ...
            <telerik:RadWindow ID="RadWindow3" runat="server" Modal="true" Title="انتخاب پرسنل"
                VisibleOnPageLoad="True" VisibleTitlebar="true" VisibleStatusbar="true" Visible="False"
                Height="500px" Width="500px" Style="z-index: 8001;" Behaviors="Close">
                <ContentTemplate>
                    <asp:Panel ID="Panel6" runat="server" Font-Names="Tahoma" Font-Size="12px">
                    ...
                    <asp:Panel ID="Panel7" runat="server" Font-Names="Tahoma" HorizontalAlign="Center">
                        <telerik:RadButton ID="rBtnEmployeeSelect" runat="server" Text="انتخـاب" Font-Names="Tahoma"
                            OnClick="rBtnEmployeeSelect_Click">
                        </telerik:RadButton>
                    </asp:Panel>
                </ContentTemplate>
            </telerik:RadWindow>
        ...
        <table width="100%">
            <tr>
                ...
                <td style="background-color: #dddddd; text-align: right; vertical-align: middle">
                    ...
                    <asp:LinkButton ID="lnkDepartment" runat="server" OnClick="lnkDepartment_Click">انتخاب دپارتمان</asp:LinkButton>
                    ...
                    <asp:LinkButton ID="lnkEmployeeSelect" runat="server" OnClick="lnkEmployeeSelect_Click">انتخاب پرسنل</asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td style="background-color: #4682B4; text-align: left; color: White; width: 200px;">
