...
public partial class Student_Enrollment_pageStartEnrollment : Page
{
    ...
    protected void btnStart_Click(object sender, EventArgs e)
    {
        ...
        {
            rSimpleMessageBox1.ShowInformation("رشته/ترم/سطح ثبت نامی را انتخاب کنید");
            return;
        }
        ...
        try
        {
            ...
            StudentConfiguration configuration = null;
            ...
            Response.Redirect("~/Student/Enrollment/pageSectionEnrollment2.aspx");
        }
        catch (Exception ex)
        {
