...
namespace rTwain
{
    ...
    public class Twain
    {
        ...
        public Twain()
        {
            ...
            appid.Version.Info = "MyApplication 1";
            ...
            appid.ProductName = "MyApplication";
        ...
        protected void OnDocumentScanned(IntPtr image)
        {
            if (DocumentScanned != null)
                DocumentScanned(this, new DocumentScannedEventArgs() {ImageHandle = image});
        }

        public IntPtr TransferPicture()
        {
            ...
            HasPendingTransfer = pxfr.Count != 0;
