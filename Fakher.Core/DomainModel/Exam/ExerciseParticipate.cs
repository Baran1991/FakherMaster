...
{
    public class ExerciseParticipate : ExamParticipate
    {
        [MaximumLength]
        ...
        //public virtual int RemainingTime { get; set; } = -1;
        public ExerciseParticipate()
        {
...
//                TimeSpan elapsedTimeSpan = DateTime.Now - new DateTime(dateTime.Year, dateTime.Month, dateTime.Day, StartHour, StartMinute, StartSecond);
                ...
                TimeSpan endDurationTimeSpan = TimeSpan.FromMinutes(Exam.AnsweringDeadline) - elapsedTimeSpan;
        ...
        //public virtual void SetRemainingTime(int time)
        //{
        //    rema
        //}
...
//            }
        ...
        public virtual bool CanParticipation(PersianDate date, int hour, int minute)
        {
            ...
            DateTime startSystemDateTime = Exam.InternetRegisterStartDate.ToSystemDateTime();
            DateTime endSystemDateTime = Exam.InternetRegisterFinishDate.ToSystemDateTime();

            DateTime now = new DateTime(nowSystemDateTime.Year, nowSystemDateTime.Month, nowSystemDateTime.Day, hour, minute, 0);
            DateTime startDateTime = new DateTime(startSystemDateTime.Year, startSystemDateTime.Month, startSystemDateTime.Day, Exam.InternetRegisterStartHoure, Exam.InternetRegisterStartMinute, 0);
            DateTime endDateTime = new DateTime(endSystemDateTime.Year, endSystemDateTime.Month, endSystemDateTime.Day, Exam.InternetRegisterFinishHoure, Exam.InternetRegisterFinishMinute, 0);
